...
local maxWeld = CreateConVar( "wire_expression2_max_constraints_weld", "0", cvFlags, "" )
local maxRope = CreateConVar( "wire_expression2_max_constraints_rope", "0", cvFlags, "" )
local maxAxis = CreateConVar( "wire_expression2_max_constraints_axis", "0", cvFlags, "" )
local maxTotal = CreateConVar( "wire_expression2_max_constraints_total", "0", cvFlags, "" )
local maxSlider = CreateConVar( "wire_expression2_max_constraints_slider", "0", cvFlags, "" )
local maxElastic = CreateConVar( "wire_expression2_max_constraints_elastic", "0", cvFlags, "" )
local maxNocollide = CreateConVar( "wire_expression2_max_constraints_nocollide", "0", cvFlags, "" )
local maxHydraulic = CreateConVar( "wire_expression2_max_constraints_hydraulic", "0", cvFlags, "" )
local maxPerEntity = CreateConVar( "wire_expression2_max_consttraints_per_entity", "0", cvFlags, "" )
local maxBallsocket = CreateConVar( "wire_expression2_max_constraints_ballsocket", "0", cvFlags, "" )
local maxAdvBallsocket = CreateConVar( "wire_expression2_max_constraints_ballsocket_adv", "0", cvFlags, "" )
